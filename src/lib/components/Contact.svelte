...
<section id="contact" class="py-20 md:py-28">
	<div class="container mx-auto px-4 md:px-6">
		...
		<div class="flex flex-col gap-4 text-center mb-16">
			<h2 bind:this={contactHeading} class="text-3xl md:text-4xl lg:text-5xl font-bold">
				Get In <span class="text-violet-400">Touch</span>
			</h2>
			<p bind:this={contactSubheading} class="text-lg text-gray-400 max-w-2xl mx-auto">
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
			<!-- Contact Form -->
			<div bind:this={contactForm} class="bg-gray-900/50 border border-gray-800 rounded-xl p-8">
				...
				<form on:submit|preventDefault={handleSubmit} class="space-y-6">
					...
					{#if submitSuccess}
						<div
							class="p-4 bg-green-900/30 border border-green-500 rounded-lg text-green-400 text-sm"
						>
			...
			<!-- Contact Information -->
			<div bind:this={contactInfo} class="flex flex-col justify-between">
				<div class="space-y-8">
					<div>
					...
					<div class="space-y-6">
						...
						<div class="flex items-start gap-4">
							<div
								class="w-12 h-12 rounded-full bg-violet-900/30 flex items-center justify-center flex-shrink-0"
							>
            ...
            <div class="flex items-start gap-4">
              <div
                class="w-12 h-12 rounded-full bg-violet-900/30 flex items-center justify-center flex-shrink-0"
              >
                <i class="fa-brands fa-whatsapp text-violet-400"></i>
              </div>
              <div>
                <h4 class="text-lg font-medium text-white">Contact</h4>
                <a
                  href="https://wa.me/03007005268"
                  class="text-gray-400 hover:text-violet-400 transition-colors duration-300"
                  target="_blank"
