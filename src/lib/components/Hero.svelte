  ...
  <div class="container mx-auto px-4 md:px-6">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div class="flex flex-col gap-6 md:gap-8">
        ...
        >
          <span class="bg-gradient-to-r from-violet-400 via-indigo-500 to-violet-400 bg-clip-text text-transparent">
            Muhammad Huzaifa
          </span>
        </h1>
        ...
        <p 
          ...
          class="text-lg md:text-xl text-gray-300 max-w-xl"
        >
          Specialized in building modern web applications with expertise in Blockchain, IoT, and creating scalable solutions that deliver exceptional user experiences.
        </p>
        ...
        <div class="flex flex-wrap gap-2 mt-4">
          ...
          <span class="px-3 py-1 rounded-full bg-violet-900/30 text-violet-300 text-sm">TypeScript</span>
          <span class="px-3 py-1 rounded-full bg-violet-900/30 text-violet-300 text-sm">Tailwind CSS</span>
          <span class="px-3 py-1 rounded-full bg-violet-900/30 text-violet-300 text-sm">Blockchain</span>
          <span class="px-3 py-1 rounded-full bg-violet-900/30 text-violet-300 text-sm">Firebase</span>
        </div>
      </div>
      ...
      >
        <div class="relative w-full max-w-md">
          ...
          <!-- Decorative Elements -->
          <div class="absolute -top-6 -right-6 w-64 h-64 bg-violet-600/20 rounded-full blur-3xl"></div>
          <div class="absolute -bottom-10 -left-10 w-72 h-72 bg-indigo-600/20 rounded-full blur-3xl"></div>
          
          <!-- Code Snippet Decoration -->
          <div class="absolute -bottom-8 -left-8 w-32 h-32 bg-black/80 border border-violet-500/30 rounded-lg flex items-center justify-center p-4 shadow-lg backdrop-blur-sm">
