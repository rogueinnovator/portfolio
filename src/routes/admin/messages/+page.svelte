    ...
    {:else if messages.length === 0}
      <div class="flex flex-col items-center justify-center py-20 text-gray-400">
        ...
        <p class="max-w-md text-center">
          You haven't received any messages yet. When visitors submit the contact form, their messages will appear here.
        </p>
      </div>
              ...
              <tr class="hover:bg-gray-800/30 transition-colors duration-150">
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-indigo-900/30 flex items-center justify-center text-indigo-400">
                ...
                <td class="px-6 py-4">
                  <div class="text-sm text-gray-300 line-clamp-2">{message.message?.substring(0, 100)}...</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-300">{message.createdAt ? formatDate(message.createdAt) : 'N/A'}</div>
                </td>
  ...
  <div class="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
    <div class="bg-gray-900 rounded-lg max-w-md w-full p-6 border border-gray-800 shadow-xl">
      ...
      <p class="text-gray-300 mb-6">
        Are you sure you want to delete this message from <span class="font-semibold text-white">{messageToDelete?.name || 'Unknown'}</span>? This action cannot be undone.
      </p>
      ...
      <div class="space-y-4">
        ...
        <div class="bg-gray-800/50 p-4 rounded-lg">
          <div class="flex items-center gap-4 mb-2">
            <div class="w-12 h-12 rounded-full bg-indigo-900/30 flex items-center justify-center text-indigo-400">
              <i class="fa-solid fa-user"></i>
            </div>
            <div>
