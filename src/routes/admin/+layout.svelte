...
<header class="bg-gray-900 border-b border-gray-800 shadow-md w-full">
...
<div class="flex h-screen bg-gray-950 text-white">
	<!-- Sidebar -->
	<aside
		class="fixed md:relative z-20 flex flex-col w-64 h-screen transition-all duration-300 bg-gray-900 border-r border-gray-800 shadow-lg {isSidebarOpen
			? 'translate-x-0'
	...
	<div class="flex-1 flex flex-col overflow-hidden">
		...
		<!-- Page Content -->
		<main class="flex-1 overflow-y-auto bg-gray-950 p-4">
			<slot />
		</main>
	</div>
</div>
